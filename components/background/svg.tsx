...
interface BackgroundSvgProps extends SvgProps {
  /**
   * Color for the left blob shape (default: theme primary or "#634B67")
   */
  blobLeftColor?: string;
  /**
   * Color for the right blob shape (default: "#695B5E")
   */
  blobRightColor?: string;
  /**
   * Color for the small accent circle (default: "#F4BEFF")
   */
  accentCircleColor?: string;
  /**
   * Color for the large ring stroke (default: "#392D28")
   */
 ...
 * BackgroundSvg
 *
 * Themed SVG background that accepts color props so it can
 * adapt to light / dark themes or any custom palette.
 *
 * Usage:
 * ```tsx
 * <BackgroundSvg
